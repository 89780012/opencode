...
export function WorkspaceFileTabs(props: Props) {
  ...
  return (
    <div className="flex items-end border-b bg-muted/15 pt-1">
      <Scroll.Root className="relative min-w-0 flex-1">
      ...
      {props.side ? <div className="flex shrink-0 items-center gap-2 pb-1 pl-2">{props.side}</div> : null}
    </div>
  )
}
