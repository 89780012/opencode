      ...
      top={
        <div className="rounded-xl border border-amber-200 bg-amber-50/85 px-3 py-3">
          <div className="flex items-center gap-2 text-[11px] font-medium text-amber-700">
            <span className="rounded-full border border-amber-200 bg-white px-2 py-0.5">Implement</span>
            <span className="rounded-full border border-amber-200 bg-white px-2 py-0.5">Verify</span>
          </div>
          <div className="mt-2 text-[12px] leading-5 text-amber-950/75">负责真实改动与验证结果，是工作流的执行位。</div>
        </div>
      }
    />
  )
