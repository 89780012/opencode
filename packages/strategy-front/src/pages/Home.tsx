...
export default function Home() {
  ...
  return (
    <div className="flex h-full w-full min-w-0">
      ...
      <div className={cn("relative flex h-full min-w-0 flex-col", workspace ? "w-[34%] min-w-[420px]" : "w-full")}>
        <div className="border-b px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              >
                <SelectTrigger className="h-9 min-w-52  px-3 text-left text-sm text-white shadow-none">
        ...
        {!workspace ? (
          ...
          <div className="flex min-h-0 flex-1 flex-col">
            ...
            <div className="shrink-0">
              <div className="mx-auto w-full max-w-[640px] space-y-3 px-4 py-2">
                {permission.req ? (
                  <PermissionPanel
