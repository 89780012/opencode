...
import type { AgentBody, AgentChange, GlobalAgentCatalog, RuntimeAgent } from "@/types/agent"
...
export const agentApi = {
  ...
  updateGlobal(name: string, body: Pick<AgentBody, "content">) {
    return request.put<AgentChange, Pick<AgentBody, "content">>(`/opencode/agents/${encodeURIComponent(name)}`, body)
  },
